...
class SupertrendStrategy(IStrategy):
    ...
    def custom_stake_amount(self, current_time: datetime, current_rate: float,
        ...
        stake = min(stake, balance * 0.25)  # Hard cap 25%
    ...
    def adjust_trade_position(self, trade: Trade, current_time: datetime,
                              ...
                              **kwargs) -> float | None:
        """Partial exit for big winners: lock profits while letting tail run."""

...
| — | — | **下輪待辦**：ccxt-okx 真實 wiring (有 demo key 可動) OR signal-health API (P4 Gate 工具) OR /metrics Prometheus format (補 /stats 的 textual 替代版) OR pending_orders dashboard panel | ⬜ |

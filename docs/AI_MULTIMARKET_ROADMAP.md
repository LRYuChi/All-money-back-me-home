...
| **E. 策略 DSL** | 🟡 | YAML schema ✅；predicate language ✅；loader ✅；evaluator ✅；registry ✅；**首個 prod 策略 yaml + 端到端整合測試 (9 cases 一次過綠) ✅**；live daemon wiring / dashboard / 多策略 ⬜ | rule-only 鏈路完整可運行 |
| **F. 跨市場** | ⬜ | — | 需 R3/R4 拍板 |
| **G. 風險統一** | ⬜ | — | — |
| **H. Live ramp** | ⬜ | — | — |
...
| — | — | **下輪待辦**：Daemon wiring (訂閱 signal_history → fuser → strategy) OR Audit log hook OR Kronos predictor (需 R1) | ⬜ |

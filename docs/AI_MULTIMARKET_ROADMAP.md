...
| — | — | **下輪待辦**：signal-health API (P4 Gate 工具) OR pending_orders dashboard panel OR per-symbol live demo trial (打一筆 demo 訂單驗證 amount_to_precision) OR retry/backoff for transient NETWORK_ERROR | ⬜ |

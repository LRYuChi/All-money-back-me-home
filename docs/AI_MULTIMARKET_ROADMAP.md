...
| — | — | **下輪待辦**：signal-health API (P4 Gate 工具) OR pending_orders dashboard panel OR per-symbol live demo trial OR worker CLI `--retry-max-attempts/--retry-base-delay` flags 暴露給 ops | ⬜ |

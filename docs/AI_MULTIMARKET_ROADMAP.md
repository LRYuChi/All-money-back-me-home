...
| — | — | **下輪待辦**：daemon wiring (smart_money shadow daemon 預設啟用 dedup，window 從 settings 讀) OR signal-health API OR worker CLI 暴露 retry policy flags OR pending_orders dashboard panel | ⬜ |

...
| **B. 基礎設施** | 🟡 | UniversalSignal schema ✅；signal_history migration ✅；SM adapter ✅；reflection/Redis/Snapshot/Credential ⬜；dual-write 🟡 | 33 新 tests 全綠 |
| **C. Kronos 整合** | ⬜ | — | 需 R1 拍板 |
| **D. AI + 融合** | ⬜ | — | 需 R2 拍板 |
| **E. 策略 DSL** | ⬜ | — | 需 R5 拍板 |
| **F. 跨市場** | ⬜ | — | 需 R3/R4 拍板 |
...
| — | — | **下輪待辦**：SM daemon 實際 dual-write 到 signal_history + persistence helper | ⬜ |

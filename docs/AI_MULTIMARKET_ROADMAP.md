...
| — | — | **下輪待辦**：worker CLI 暴露 retry policy flags (round 43 leftover) OR signal-health API OR pending_orders dashboard panel OR settings 加 SM_INTENT_DEDUP_WINDOW_SEC env 配置 (--intent-dedup-window-sec 的 12-factor 對應) | ⬜ |
